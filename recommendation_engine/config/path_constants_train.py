...
SDAE_MODEL_PATH = os.path.join(ECOSYSTEM, 'models/sdae-model/')
TENSORBOARD_DIR = os.path.join(ECOSYSTEM, "training-{}".format(time.strftime))
# Paths that are required for training
TENSORBOARD_LOGDIR_LOCAL = pathlib.Path('/tmp/autoencoder/')
LOCAL_MODEL_DIR = '/tmp/'
